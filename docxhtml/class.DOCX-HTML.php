...
class DOCXtoHTML {
    ...
    /**
     * @var Bool Should Paragraph tags be used or rather the new line characters
     * @since 1.1
     */
    var $paragraphs = true;
    ...
    function extractRelXML(){
        ...
        foreach($data as $value){
            if($value['tag']=="RELATIONSHIP"){
                //it is an relationship tag, get the ID attr as well as the TARGET and set into var.
